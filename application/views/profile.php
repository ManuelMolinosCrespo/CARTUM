...
<body>
	...
	<div class="container-fluid">
		<div class="row col-md-offset-1">
			<h3 class="color-letter">Información personal <a href="<?php echo base_url() ?>application/controllers/profile_controller/cargar_editar" class="color-letter"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></h3>
			<hr>
		</div>
		<div class="row">
